...
from input_data_advanced_Etna import *
from input_data_Etna import *
...
shutil.copy2('input_data_advanced_Etna.py', backup_advanced_file)
shutil.copy2('input_data_Etna.py', backup_file)
